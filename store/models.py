...
class Product(models.Model):
    ...
    @property
    def imageURL(self):
        """Class representing a Image URL"""
...
class Order(models.Model):
    ...
    def get_cart_total(self):
        """Class representing a get cart total"""
    ...
    def get_cart_items(self):
        """Class representing a get cart items"""
        orderitems = self.orderitem_set.all()
...
class OrderItem(models.Model):
    """Class representing a orderItem"""
...
class CustomerRegister(models.Model):
    """Class representing a Customer registration"""
